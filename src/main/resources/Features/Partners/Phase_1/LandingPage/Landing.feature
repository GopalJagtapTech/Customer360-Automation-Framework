Feature: Landing Page
  ...
  Scenario Outline: To verify customer is able to view Below Options "<Options>" for Search By Dropdown
    ...
    Examples:
      ...
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | Mobile Number#Customer ID#Agreement Number#EMI Card Number#Fixed Deposit Number#FD Application Number#FD Reference Number#Deal Number#Application ID#Email ID#PAN Number#Bank Account Number#Policy Number#Old Mobile Number |
