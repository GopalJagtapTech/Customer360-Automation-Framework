Feature:  Widgets
  ...
  Scenario Outline: To verify User is able to view Options under Widgets on Dashboard Page
    ...
    Examples:
      ...
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | GST, Dedupe Linkage, Voucher Details, Demographic Details, Comm Audit Trail, Chat History, SICR |
