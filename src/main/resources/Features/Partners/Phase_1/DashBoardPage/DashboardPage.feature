Feature: Dashboard Page
  ...
  Scenario Outline: To verify User is able to view Quick Links Section on Dashboard Page
    ...
    Examples:
      ...
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | OFFERS#BUREAU INSIGHTS#RAISE SR#CTR#PII#RMS |
