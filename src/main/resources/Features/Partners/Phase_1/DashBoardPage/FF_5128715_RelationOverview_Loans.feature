...
#    Then User should be able to view SOA,RPS,NDC,interest Certificate reports include SMS icon and PDF icon on loan cards
    Examples:
      ...
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | SOA      |
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | RPS      |
  ...
  Scenario Outline: To verify that User is able to view "<Document>" reports include SMS icon and PDF icon on loan cards
    ...
    Examples:
      | Domain  | Username | Password | Url                                            | Dashboard                                        | Document |
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | NDC      |
  ...
  Scenario Outline: To verify that User is able to view number of language options on pop up
    ...
    Examples:
      ...
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | ENGLISH#TAMIL#KANNADA#MARATHI#HINDI#GUJARATI#BENGALI#TELUGU#PUNJABI |
...
#      | Partner | 202432943 | Abhi@12345   | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | Loans, Cards, Insurance, fd |
  ...
  Scenario Outline:To verify that on click of SMS icon for "<Doc>" - reports pop up is displayed
    ...
    Examples:
      ...
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | SOA | 9833728591 | 405DPFKA311104 |
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | RPS | 9833728591 | 405DPFKA311104 |
  ...
  Scenario Outline:To verify that on click of SMS icon for "<Doc>" - reports pop up is displayed
    ...
    Examples:
      | Domain  | Username | Password | Url                                            | Dashboard                                        | Doc | Mobile     | Relation       |
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | NDC | 9443703371 | 5550PL15072698 |
...
#    Then Welcome letter should be download via PFD and opening in new tab
    Examples:
      ...
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | https://documents.bajajfinserv.in/Welcome_Letter/DocPOD/Index |
...
#    And click on PDC PDF
#    Then On click of PDF icon PDC report should be displayed
    Examples:
...
##############New
  ...
  Scenario Outline: To verify that User is able to download the File when clicks on "<Document>"
    ...
    Examples:
      | Domain  | Username | Password | Url                                            | Dashboard                                        | Document  |
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | FC Letter |
  ...
  Scenario Outline: To verify that User is redirected to Url when clicks on "<Document>"
    ...
    Examples:
      ...
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | PDC            | https://report.bajajfinserv.in/PDCReport                      |
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | Scanned Docs   | https://dmsapp.bajajfinserv.in/finserv/viewDoc.jsp            |
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | Welcome Letter | https://documents.bajajfinserv.in/Welcome_Letter/DocPOD/Index |
  ...
  Scenario Outline: To verify that User is able to view Financial Year Dropdown when clicks on "<Document>"
    ...
    Examples:
      | Domain  | Username | Password | Url                                            | Dashboard                                        | Document                |
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | Interest Certificate    |
      | Partner | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | Provisional Certificate |
