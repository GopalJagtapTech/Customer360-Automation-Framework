Feature: US_5233402 _Bounce count popup page development in customer portfolio widget
  ...
  Scenario Outline: To verify that pop up is display when user is  click on bounce count under customer portfolio ribbon
    ...
    Examples:
      ...
      | CC     | 202432943  | Finserv@12345  | https://customer360uat.bajajfinserv.in/landing | https://customer360uat.bajajfinserv.in/dashboard | SOA, AGREEMENT NO., APPLICATION ID, SANCTIONED AMt., PRODUCT TYPE, MOB, TENURE, LOAN STATUS, POS, TRACK RECORD |
